...
Feature: Some of the general functionality verification
  ...
  Scenario: Order placement scenario
    ...
    And user enters customer name "Sevilay Gny"
    ...
    And user enters credit card number "123456789100"
    And user enters expiration date "12/25"
    And user clicks to process order button
    Then user should see "Sevilay Gny" in the first row of the web table
